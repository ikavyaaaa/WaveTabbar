...
class ViewController: UITabBarController, UITabBarControllerDelegate {
    override func viewDidLoad() {
        ...
        // Adjust appearance for tab bar items
        UITabBar.appearance().itemPositioning = .centered // Center items above wave
        UITabBar.appearance().itemSpacing = 0            // Adjust spacing
